...
const COUNTRY_OPTIONS = [
  ...
  {
    label: "🇪🇺 European Union (€49)",
    value: "EU",
    currency: "EUR",
    amount: 49,
  },
  {
    label: "🌍 Other Countries (€49)",
    value: "OTHER",
    currency: "EUR",
    amount: 49,
  },
...
export default function PremiumPage() {
  ...
  useEffect(() => {
    ...
    const isIndian =
      timeZone.includes("Asia/Kolkata") || timeZone.includes("India");
    if (isIndian) {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Enhance your IMAT preparation with our comprehensive suite of
            premium mock tests designed to help you succeed.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden flex flex-col w-full md:w-1/2 border-2 border-blue-500 transform md:scale-105 z-10">
            <div className="p-6 bg-blue-500 text-white">
              <div className="inline-block px-3 py-1 text-xs font-semibold bg-white text-blue-600 rounded-full mb-3">
                ONE-TIME PAYMENT
              </div>
            ...
            <div className="p-6 flex-grow">
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-800">
                    <strong>All in Free Access</strong>
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="text-gray-800">
                    <strong>Access to ALL premium tests</strong>
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-800">
                    1 year of updates and new content
                  </span>
                </li>
              </ul>
            </div>
            <div className="p-6 bg-gray-50">
              ...
              <p className="text-xs text-center text-gray-500 mt-3">
                {isIndianUser
                  ? "Secure payment via Razorpay (UPI, Netbanking, Cards)"
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div>
              ...
              <p className="text-gray-600">
                5+ additional premium mock tests designed by IMAT experts
              </p>
            </div>
            <div>
              <div className="bg-blue-100 rounded-full h-16 w-16 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Detailed performance tracking and analytics to focus your study
              </p>
            </div>
            <div>
              <div className="bg-blue-100 rounded-full h-16 w-16 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                No recurring fees - pay once and get access for a full year
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600">
                This is a one-time payment of {isIndianUser ? "₹4,499" : "€49"}.
                You&apos;ll get full access to all premium tests for one year.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600">
                {isIndianUser
                  ? "We accept all major payment methods in India including UPI (Google Pay, PhonePe, Paytm), Net Banking, Credit/Debit Cards, and Wallets through our secure payment processor, Razorpay."
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600">
                You&apos;ll immediately get access to all premium tests. Your
                premium status is linked to your account, so you can access
                premium content from any device.
              </p>
            </div>
          </div>
        </div>
