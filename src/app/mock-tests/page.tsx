...
const mockTests = [
  {
    ...
    description: 'Full-length mock test with 60 realistic questions covering all IMAT test categories.',
    questionCount: 60,
  ...
  },
  {
    ...
    description: 'Comprehensive chemistry test covering organic, inorganic, and biochemistry.',
    questionCount: 30,
    timeLimit: 50,
  ...
  },
  {
    ...
    description: 'Specialized test for physics and mathematical concepts relevant to IMAT.',
    questionCount: 30,
    timeLimit: 50,
  ...
  },
  {
    ...
    description: 'Specialized test on reading comprehension, critical thinking, and logical reasoning.',
    questionCount: 20,
    timeLimit: 40,
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Available Mock Tests</h1>
          <p className="mt-2 text-gray-700">
            Choose a mock test to practice your IMAT skills. Each test follows the official exam format.
          </p>
          {!isSignedIn && (
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              <p className="text-blue-700">
                <Link href="/auth/login" className="font-medium underline">Sign in</Link> to track your progress and access premium tests.
              </p>
            </div>
          )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mockTests.map((test) => (
            <div key={test.id} className={`bg-white rounded-lg shadow-md overflow-hidden ${test.isPremium && !hasSubscription ? 'border-yellow-300 border' : ''}`}>
              <div className="p-6">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden border-2 border-dashed border-blue-300">
            <div className="p-6">
              <div className="flex justify-between items-start">
                <h2 className="text-xl font-semibold text-gray-900 mb-2">New Tests Coming Soon</h2>
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                  Next Saturday
                </span>
              </div>
              <p className="text-gray-700 mb-4">Stay tuned for our next batch of practice tests. We add new content every week to help you prepare effectively.</p>
              <div className="flex justify-between text-sm text-gray-700 mb-4">
        ...
        <div className="mt-12 bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">About Our Mock Tests</h2>
          <div className="prose max-w-none text-gray-700">
            <p>
              Our mock tests are designed to simulate the real IMAT exam experience. Each full mock test includes:
            </p>
            <ul className="list-disc pl-5 mt-2 mb-4">
              <li>60 multiple-choice questions following the official distribution</li>
              <li>100-minute time limit</li>
              <li>Scoring system matching the official IMAT scoring (+1.5 for correct, -0.4 for incorrect)</li>
              <li>Detailed explanations for all answers</li>
            </ul>
            <p>
              Taking regular practice tests is one of the most effective ways to prepare for the IMAT exam. 
              It helps you become familiar with the exam format, improve your time management, and identify your weak areas.
            </p>
          </div>
        </div>
      </div>
