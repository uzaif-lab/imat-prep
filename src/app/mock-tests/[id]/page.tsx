...
const mockTests = {
  "1": {
    ...
    description:
      "Based on the 2023 IMAT exam pattern with similar difficulty level.",
    ...
    questions: [
      // Reading Comprehension (2 questions)
      {
        ...
        options: [
          {
            id: "A",
            text: "The human genome project was completed behind schedule",
          },
          {
            id: "B",
            text: "James Watson was the sole researcher involved in the project",
          },
          { id: "C", text: "The project identified over 30,000 human genes" },
          {
            id: "D",
            text: "The project was completed in 2003, two years earlier than planned",
          },
          {
            id: "E",
            text: "The human genome project only focused on mapping genes without practical applications",
          },
        ],
        correctOption: "D",
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "The identification of cyclin-dependent kinases as cell cycle regulators",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "D",
            text: "It can transport molecules against their concentration gradient",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "Enzymes are consumed in the reactions they catalyze",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "The movement of mRNA from the nucleus to the cytoplasm",
          },
          {
            id: "C",
            text: "The assembly of amino acids into a polypeptide chain",
          },
          {
            id: "D",
            text: "The folding of a polypeptide into its tertiary structure",
          },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "They are produced by the same cells in the pancreas",
          },
          { id: "B", text: "They both increase blood glucose levels" },
          {
            id: "C",
            text: "They have antagonistic effects on blood glucose levels",
          },
          {
            id: "D",
            text: "They are both produced in response to high blood glucose",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "DNA is single-stranded, while RNA is double-stranded",
          },
          {
            id: "C",
            text: "DNA contains deoxyribose sugar, while RNA contains ribose sugar",
          },
          {
            id: "D",
            text: "DNA contains phosphate groups, while RNA does not",
          },
          {
            id: "E",
            text: "DNA is found only in the nucleus, while RNA is found only in the cytoplasm",
          },
        ],
        correctOption: "C",
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "To increase the speed of nerve impulse conduction",
          },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Spermatogonia → primary spermatocyte → secondary spermatocyte → spermatid → sperm",
          },
          {
            id: "B",
            text: "Spermatogonia → spermatid → primary spermatocyte → secondary spermatocyte → sperm",
          },
          {
            id: "C",
            text: "Primary spermatocyte → spermatogonia → secondary spermatocyte → spermatid → sperm",
          },
          {
            id: "D",
            text: "Spermatogonia → secondary spermatocyte → primary spermatocyte → spermatid → sperm",
          },
          {
            id: "E",
            text: "Primary spermatocyte → secondary spermatocyte → spermatogonia → spermatid → sperm",
          },
        ],
        correctOption: "A",
      },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Hydrolysis of esters to produce alcohols and acids",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "Isotopes of an element have different numbers of electrons",
          },
          {
            id: "C",
            text: "Isotopes of an element have different numbers of neutrons",
          },
          {
            id: "D",
            text: "Isotopes of an element have different chemical properties",
          },
          {
            id: "E",
            text: "Isotopes of an element cannot be separated physically",
          },
        ],
        correctOption: "C",
      },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "A reaction that absorbs heat from the surroundings",
          },
          {
            id: "B",
            text: "A reaction that releases heat to the surroundings",
          },
          { id: "C", text: "A reaction that occurs only at high temperatures" },
          { id: "D", text: "A reaction that requires a catalyst" },
          {
            id: "E",
            text: "A reaction that occurs spontaneously at low temperatures",
          },
        ],
        correctOption: "B",
      },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Reaction rate decreases exponentially with increasing temperature",
          },
          {
            id: "B",
            text: "Reaction rate increases linearly with increasing temperature",
          },
          {
            id: "C",
            text: "Reaction rate increases exponentially with increasing temperature",
          },
          { id: "D", text: "Reaction rate is independent of temperature" },
          {
            id: "E",
            text: "Reaction rate only increases with temperature in endothermic reactions",
          },
        ],
        correctOption: "C",
      },
      ...
      {
        id: "q59",
        text: "A pendulum has a period of 2 seconds. What is its frequency?",
        category: "physics_math",
        options: [
          { id: "A", text: "0.25 Hz" },
          { id: "B", text: "0.5 Hz" },
    ...
    questions: [
      // Reading Comprehension (2 questions)
      {
        ...
        options: [
          {
            id: "A",
            text: "Epigenetic changes always involve alterations to the DNA sequence",
          },
          {
            id: "B",
            text: "Epigenetic modifications can be influenced by environmental factors",
          },
          { id: "C", text: "Epigenetic changes cannot be passed to offspring" },
          {
            id: "D",
            text: "The field of epigenetics has no relevance to disease treatment",
          },
          {
            id: "E",
            text: "Epigenetic modifications only occur during embryonic development",
          },
        ],
        correctOption: "B",
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Through a systematic screening of thousands of compounds",
          },
          {
            id: "B",
            text: "By deliberate genetic modification of mold species",
          },
          {
            id: "C",
            text: "As a result of a government-funded wartime research project",
          },
          {
            id: "D",
            text: "Through accidental contamination of a bacterial culture",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "C",
            text: "Insulin secretion in response to high blood glucose",
          },
          { id: "D", text: "Fever development during infection" },
          {
            id: "E",
            text: "Adrenaline release during fight-or-flight response",
          },
        ],
        correctOption: "C",
      },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Right atrium → right ventricle → lungs → left atrium → left ventricle → body",
          },
          {
            id: "B",
            text: "Left atrium → left ventricle → lungs → right atrium → right ventricle → body",
          },
          {
            id: "C",
            text: "Right atrium → left atrium → right ventricle → left ventricle → lungs → body",
          },
          {
            id: "D",
            text: "Left ventricle → left atrium → lungs → right atrium → right ventricle → body",
          },
          {
            id: "E",
            text: "Right atrium → right ventricle → body → left atrium → left ventricle → lungs",
          },
        ],
        correctOption: "A",
      },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "It results in daughter cells with half the chromosome number of the parent cell",
          },
          { id: "B", text: "It only occurs in reproductive cells" },
          {
            id: "C",
            text: "It produces four genetically different daughter cells",
          },
          {
            id: "D",
            text: "It maintains the chromosome number in daughter cells",
          },
          {
            id: "E",
            text: "It involves crossing over between homologous chromosomes",
          },
        ],
        correctOption: "D",
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "It carries the genetic code from the nucleus to the ribosomes",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "It synthesizes new DNA strands during replication",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "C",
            text: "To regulate the passage of substances in and out of the cell",
          },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "The movement of water molecules from a region of higher concentration to a region of lower concentration across a semipermeable membrane",
          },
          {
            id: "B",
            text: "The active transport of solutes against a concentration gradient",
          },
          {
            id: "C",
            text: "The movement of solutes from a region of lower concentration to a region of higher concentration",
          },
          {
            id: "D",
            text: "The transport of ions through specific protein channels",
          },
          {
            id: "E",
            text: "The engulfing of external particles by the cell membrane",
          },
        ],
        correctOption: "A",
      },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Prokaryotic cells have ribosomes, while eukaryotic cells do not",
          },
          {
            id: "B",
            text: "Eukaryotic cells have a cell wall, while prokaryotic cells do not",
          },
          {
            id: "C",
            text: "Prokaryotic cells have a nucleus, while eukaryotic cells do not",
          },
          {
            id: "D",
            text: "Eukaryotic cells have membrane-bound organelles, while prokaryotic cells do not",
          },
          {
            id: "E",
            text: "Prokaryotic cells have DNA, while eukaryotic cells have RNA",
          },
        ],
        correctOption: "D",
      },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Movement of molecules against the concentration gradient using ATP",
          },
          {
            id: "B",
            text: "Passive movement of molecules through protein channels",
          },
          { id: "C", text: "Transport of large molecules via vesicles" },
          {
            id: "D",
            text: "Active transport of ions using a concentration gradient",
          },
          {
            id: "E",
            text: "Movement of water across a semipermeable membrane",
          },
        ],
        correctOption: "B",
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "Production of gametes with haploid number of chromosomes",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "C",
            text: "ATP and NADPH are produced using energy from light",
          },
          { id: "D", text: "Oxygen is consumed to generate ATP" },
          {
            id: "E",
            text: "Pyruvate is converted to carbon dioxide and water",
          },
        ],
        correctOption: "C",
      },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "It explains why the genetic code is universal across most species",
          },
          {
            id: "B",
            text: "It explains how a single tRNA can recognize multiple codons",
          },
          {
            id: "C",
            text: "It describes how DNA replication errors are corrected",
          },
          {
            id: "D",
            text: "It explains the mechanism of genetic recombination",
          },
          {
            id: "E",
            text: "It describes how mutations lead to genetic diversity",
          },
        ],
        correctOption: "B",
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "They allow for the exchange of small molecules between adjacent cells",
          },
          {
            id: "B",
            text: "They create a virtually impermeable barrier between adjacent cells",
          },
          { id: "C", text: "They anchor cells to the extracellular matrix" },
          {
            id: "D",
            text: "They facilitate direct communication through cytoplasmic channels",
          },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "How carbon dioxide affects the oxygen-binding capacity of hemoglobin",
          },
          {
            id: "B",
            text: "The relationship between atomic structure and light emission",
          },
          { id: "C", text: "How pH affects enzyme activity" },
          {
            id: "D",
            text: "The mechanism of electron transfer in photosystems",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "D",
            text: "Create a concentration gradient for water reabsorption",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "C",
            text: "Facilitate diffusion of lipids across the membrane",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "E",
            text: "To provide carbon skeletons for amino acid synthesis",
          },
        ],
        correctOption: "C",
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "They are coding regions at the beginning of genes",
          },
          {
            id: "B",
            text: "They are protective structures at the ends of chromosomes",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "To regulate the activity of cyclin-dependent kinases",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "E",
            text: "It only occurs in response to severe tissue damage",
          },
        ],
        correctOption: "C",
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "To cleave foreign DNA at specific recognition sites",
          },
          { id: "C", text: "To replicate bacterial DNA" },
          {
            id: "D",
            text: "To facilitate conjugation between bacterial cells",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "Movement of molecules against their concentration gradient",
          },
          {
            id: "C",
            text: "Passive transport of specific molecules through channel or carrier proteins",
          },
          { id: "D", text: "Bulk transport of materials via vesicles" },
          {
            id: "E",
            text: "Direct diffusion through the phospholipid bilayer",
          },
        ],
        correctOption: "C",
      },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "Return of excess tissue fluid to the circulatory system",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "To connect the right and left cerebral hemispheres",
          },
    ...
    questions: [
      // Reading Comprehension & General Knowledge (4 questions)
      {
        ...
        options: [
          {
            id: "A",
            text: "Microplastics are defined as plastic particles larger than 5mm in size",
          },
          {
            id: "B",
            text: "The health effects of microplastic exposure are thoroughly understood",
          },
          {
            id: "C",
            text: "Microplastics can originate from the breakdown of larger plastic items",
          },
          {
            id: "D",
            text: "Strict international regulations exist to control microplastic pollution",
          },
          {
            id: "E",
            text: "Microplastics have only been detected in marine environments",
          },
        ],
        correctOption: "C",
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Increasing the use of prophylactic antibiotics in healthy individuals",
          },
          {
            id: "B",
            text: "Focusing exclusively on human medical interventions",
          },
          {
            id: "C",
            text: "Expanding antimicrobial use in agriculture to prevent crop diseases",
          },
          {
            id: "D",
            text: "Improving diagnostic techniques to ensure appropriate treatment",
          },
          {
            id: "E",
            text: "Developing broader spectrum antibiotics for widespread use",
          },
        ],
        correctOption: "D",
      },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "E",
            text: "Discovery of the role of telomeres in cellular aging",
          },
        ],
        correctOption: "B",
      },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "If someone studies anatomy, they are a medical student",
          },
          {
            id: "C",
            text: "If someone does not study anatomy, they are not a medical student",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "C",
            text: "It carries electrons in the electron transport chain",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "D",
            text: "Exchange of genetic material between homologous chromosomes",
          },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Production of estrogen during the follicular phase",
          },
          { id: "B", text: "Release of the secondary oocyte during ovulation" },
          {
            id: "C",
            text: "Production of progesterone during the luteal phase",
          },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "To protect the developing embryo from the immune system",
          },
          { id: "B", text: "To provide nutrients to the early embryo" },
          {
            id: "C",
            text: "To serve as a barrier that sperm must penetrate for fertilization",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "D",
            text: "Secretion of mucus to neutralize urethral acidity",
          },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "Potassium channels open, allowing K⁺ to enter the cell",
          },
          {
            id: "B",
            text: "Sodium channels close, preventing Na⁺ from entering the cell",
          },
          {
            id: "C",
            text: "Sodium channels open, allowing Na⁺ to enter the cell",
          },
          {
            id: "D",
            text: "Calcium channels close, preventing Ca²⁺ from entering the cell",
          },
      ...
      },
      {
        ...
        options: [
          {
            id: "A",
            text: "They maintain a constant pH when strong acids are added",
          },
          {
            id: "B",
            text: "They are typically composed of a strong acid and its conjugate base",
          },
          {
            id: "C",
            text: "They work most effectively when the pH is far from the pKa of the acid",
          },
      ...
      },
      {
        ...
        options: [
          { id: "A", text: "Serine" },
          { id: "B", text: "Methionine" },
          { id: "C", text: "Histidine" },
          { id: "D", text: "Aspartic acid" },
          { id: "E", text: "Phenylalanine" },
        ],
        correctOption: "B",
      },
      {
        ...
        category: "chemistry",
        options: [
          { id: "A", text: "Condensation of water vapor" },
          { id: "B", text: "Formation of ice from liquid water" },
          { id: "C", text: "Combustion of methane" },
          { id: "D", text: "Evaporation of water" },
          { id: "E", text: "Neutralization of an acid with a base" },
        ],
        correctOption: "D",
      },
      {
        id: "q43_8",
        text: "What type of bond forms between water molecules?",
        category: "chemistry",
        options: [
          ...
          { id: "E", text: "Metallic bond" },
        ],
        correctOption: "D",
      },
      {
        id: "q44_8",
        text: "In a biochemical context, what is the primary role of NAD⁺?",
        category: "chemistry",
        options: [
          { id: "A", text: "To provide energy for ATP synthesis" },
          {
            id: "B",
            text: "To act as an electron acceptor in oxidation reactions",
          },
          {
            id: "C",
            text: "To serve as a coenzyme in decarboxylation reactions",
          },
          { id: "D", text: "To catalyze peptide bond formation" },
          { id: "E", text: "To facilitate membrane transport" },
        ],
        correctOption: "B",
      },
      {
        id: "q45_8",
        text: "Which of the following compounds would give a positive result with Benedict's reagent?",
        category: "chemistry",
        options: [
          { id: "A", text: "Starch" },
          { id: "B", text: "Sucrose" },
      ...
      {
        id: "q46_8",
        text: "What is the primary function of a zwitterion in amino acids?",
        category: "chemistry",
        options: [
          { id: "A", text: "To increase solubility in non-polar solvents" },
          {
            id: "B",
            text: "To maintain electrical neutrality while containing both positive and negative charges",
          },
          { id: "C", text: "To prevent peptide bond formation" },
          { id: "D", text: "To catalyze deamination reactions" },
          { id: "E", text: "To increase reactivity with nucleophiles" },
        ],
        correctOption: "B",
      },
      {
        id: "q47_8",
        text: "Which of the following best describes the solubility of gases in liquids as temperature increases?",
        category: "chemistry",
        options: [
          { id: "A", text: "Solubility increases" },
          { id: "B", text: "Solubility decreases" },
          { id: "C", text: "Solubility remains constant" },
          { id: "D", text: "Solubility first increases, then decreases" },
          { id: "E", text: "Solubility is not affected by temperature" },
        ],
        correctOption: "B",
      },
      // Physics & Math Questions (15 questions)
      {
        id: "q48_8",
        text: "A projectile is fired with an initial velocity of 50 m/s at an angle of 30° above the horizontal. What is its horizontal range? (g = 10 m/s²)",
        category: "physics_math",
        options: [
          { id: "A", text: "212.5 m" },
          { id: "B", text: "225.0 m" },
      ...
      {
        id: "q49_8",
        text: "The half-life of a radioactive isotope is 8 days. What fraction of the original sample remains after 32 days?",
        category: "physics_math",
        options: [
          { id: "A", text: "1/4" },
          { id: "B", text: "1/8" },
      ...
      {
        id: "q50_8",
        text: "A box of mass 2 kg is placed on an inclined plane that makes an angle of 30° with the horizontal. The coefficient of static friction between the box and the plane is 0.6. Will the box slide down the plane? (g = 10 m/s²)",
        category: "physics_math",
        options: [
          {
            id: "A",
            text: "Yes, because the component of gravity down the plane is greater than the maximum static friction force",
          },
          {
            id: "B",
            text: "No, because the component of gravity down the plane is less than the maximum static friction force",
          },
          { id: "C", text: "Yes, because the normal force is zero" },
          {
            id: "D",
            text: "No, because the net force is zero regardless of the coefficient of friction",
          },
          {
            id: "E",
            text: "Cannot be determined without knowing the length of the incline",
          },
        ],
        correctOption: "B",
      },
      {
        ...
        category: "physics_math",
        options: [
          { id: "A", text: "f'(x) = e^x · sin(x)" },
          { id: "B", text: "f'(x) = e^x · [sin(x) + cos(x)]" },
          { id: "C", text: "f'(x) = e^x · cos(x)" },
          { id: "D", text: "f'(x) = e^x · [sin(x) - cos(x)]" },
          { id: "E", text: "f'(x) = e^x · sin(x) + e^x · cos(x)" },
        ],
        correctOption: "B",
      },
      {
        id: "q52_8",
        text: "In a circuit, a resistor with resistance R is connected in series with an inductor of inductance L. If the circuit is driven by an AC voltage source with amplitude V and angular frequency ω, what is the impedance of the circuit?",
        category: "physics_math",
        options: [
          { id: "A", text: "Z = R + L" },
          { id: "B", text: "Z = R + ωL" },
      ...
      {
        id: "q53_8",
        text: "What is the centripetal acceleration of a point on the equator of the Earth due to the Earth's rotation? (Radius of Earth = 6.4 × 10⁶ m, Earth makes one rotation in 24 hours)",
        category: "physics_math",
        options: [
          { id: "A", text: "0.001 m/s²" },
          { id: "B", text: "0.01 m/s²" },
      ...
      {
        id: "q55_8",
        text: "A gas expands isothermally from a volume of 2 L to 5 L at a constant temperature of 300 K. If the initial pressure is 3 atm, what is the final pressure?",
        category: "physics_math",
        options: [
          { id: "A", text: "1.0 atm" },
          { id: "B", text: "1.2 atm" },
      ...
      {
        id: "q56_8",
        text: "Two coherent light waves with the same amplitude and frequency interfere. If the path difference between the waves is λ/2 (where λ is the wavelength), what type of interference occurs?",
        category: "physics_math",
        options: [
          { id: "A", text: "Constructive interference" },
          { id: "B", text: "Destructive interference" },
          { id: "C", text: "Partial constructive interference" },
          { id: "D", text: "No interference" },
          { id: "E", text: "Resonant interference" },
        ],
        correctOption: "B",
      },
      {
        id: "q57_8",
        text: "What is the area under the curve f(x) = 2x² + 3 from x = 0 to x = 2?",
        category: "physics_math",
        options: [
          { id: "A", text: "6" },
          { id: "B", text: "8" },
      ...
      {
        id: "q58_8",
        text: "A person with a mass of 70 kg stands on a scale in an elevator. When the elevator accelerates upward at 2 m/s², what is the reading on the scale? (g = 10 m/s²)",
        category: "physics_math",
        options: [
          { id: "A", text: "560 N" },
          { id: "B", text: "700 N" },
      ...
      {
        id: "q59_8",
        text: "If the concentration of hydrogen ions [H⁺] in a solution is 5 × 10⁻⁹ mol/L, what is the pH of the solution?",
        category: "physics_math",
        options: [
          { id: "A", text: "5.0" },
          { id: "B", text: "8.3" },
      ...
      {
        id: "q60_8",
        text: "A spring with a spring constant of 200 N/m is compressed by 0.05 m from its equilibrium position. How much energy is stored in the spring?",
        category: "physics_math",
        options: [
          { id: "A", text: "0.25 J" },
          { id: "B", text: "0.5 J" },
  ...
  "5": {
    ...
    questions: [
      {
        id: "q1_5",
        text: "Which of the following is a Lewis acid but **not** a Brønsted-Lowry acid?",
        category: "chemistry",
        options: [
          { id: "A", text: "HCl" },
          { id: "B", text: "BF₃" },
      ...
      {
        id: "q2_5",
        text: "A gas occupies 2.5 L at 300 K. What volume will it occupy at 450 K if pressure remains constant?",
        category: "chemistry",
        options: [
          { id: "A", text: "1.67 L" },
          { id: "B", text: "3.75 L" },
      ...
      {
        id: "q3_5",
        text: "Which pair of compounds represents **structural isomers**?",
        category: "chemistry",
        options: [
          { id: "A", text: "Butane and 2-methylpropane" },
          { id: "B", text: "Pentan-2-ol and pentan-3-ol" },
          { id: "C", text: "Glucose and fructose" },
          { id: "D", text: "cis-2-butene and trans-2-butene" },
          { id: "E", text: "Ethanol and dimethyl ether" },
        ],
        correctOption: "E",
      },
      {
        id: "q4_5",
        text: "Uncompetitive inhibition differs from non-competitive inhibition because uncompetitive inhibitors:",
        category: "chemistry",
        options: [
          { id: "A", text: "Bind only to the enzyme-substrate complex" },
          { id: "B", text: "Bind to the active site" },
          { id: "C", text: "Increase the Km value" },
          { id: "D", text: "Are unaffected by substrate concentration" },
          { id: "E", text: "Reduce Vmax and Km" },
        ],
        correctOption: "A",
      },
      {
        id: "q5_5",
        text: "Which substance has the **weakest** intermolecular forces?",
        category: "chemistry",
        options: [
          { id: "A", text: "Water (H₂O)" },
          { id: "B", text: "Methane (CH₄)" },
          { id: "C", text: "Ethanol (C₂H₅OH)" },
          { id: "D", text: "Ammonia (NH₃)" },
          { id: "E", text: "Glycerol (C₃H₈O₃)" },
        ],
        correctOption: "B",
      },
      {
        id: "q6_5",
        text: "In the reaction 2Mg + O₂ → 2MgO, which species is oxidized?",
        category: "chemistry",
        options: [
          { id: "A", text: "Mg" },
          { id: "B", text: "O₂" },
          { id: "C", text: "MgO" },
          { id: "D", text: "Both Mg and O₂" },
      ...
      {
        id: "q7_5",
        text: "Which molecule is a direct input into the Krebs cycle?",
        category: "chemistry",
        options: [
          { id: "A", text: "Glucose" },
          { id: "B", text: "Pyruvate" },
      ...
      {
        id: "q8_5",
        text: "Which gas is **not** a greenhouse gas?",
        category: "chemistry",
        options: [
          { id: "A", text: "Carbon dioxide (CO₂)" },
          { id: "B", text: "Methane (CH₄)" },
          { id: "C", text: "Nitrogen (N₂)" },
          { id: "D", text: "Water vapor (H₂O)" },
          { id: "E", text: "Ozone (O₃)" },
        ],
        correctOption: "C",
      },
      {
        id: "q9_5",
        text: "If 10 g of H₂ reacts with 64 g of O₂ to form water, what is the limiting reactant?",
        category: "chemistry",
        options: [
          { id: "A", text: "H₂" },
          { id: "B", text: "O₂" },
          { id: "C", text: "H₂O" },
          { id: "D", text: "Both are consumed completely" },
      ...
      {
        id: "q11_5",
        text: "Which of the following electron configurations represents a noble gas?",
        category: "chemistry",
        options: [
          ...
          { id: "E", text: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶" },
        ],
        correctOption: "B",
      },
      {
        id: "q12_5",
        text: "What is the IUPAC name for the following compound?\nCH₃-CH(OH)-CH₂-CH₃",
        category: "chemistry",
        options: [
          { id: "A", text: "1-butanol" },
          { id: "B", text: "2-butanol" },
          { id: "C", text: "3-butanol" },
          { id: "D", text: "Butanone" },
          { id: "E", text: "Butanoic acid" },
        ],
        correctOption: "B",
      },
      {
        id: "q13_5",
        text: "Which of the following processes is always spontaneous?",
        category: "chemistry",
        options: [
          { id: "A", text: "Endothermic reaction with increasing entropy" },
          { id: "B", text: "Endothermic reaction with decreasing entropy" },
          { id: "C", text: "Exothermic reaction with increasing entropy" },
          { id: "D", text: "Exothermic reaction with decreasing entropy" },
          { id: "E", text: "None of the above" },
        ],
        correctOption: "C",
      },
      {
        id: "q14_5",
        text: "For the reaction N₂(g) + 3H₂(g) ⇌ 2NH₃(g), which change would shift the equilibrium to produce more ammonia?",
        category: "chemistry",
        options: [
          { id: "A", text: "Increasing the temperature" },
          { id: "B", text: "Decreasing the pressure" },
          { id: "C", text: "Adding a catalyst" },
          { id: "D", text: "Removing H₂" },
          { id: "E", text: "Adding more N₂" },
        ],
        correctOption: "E",
      },
      {
        id: "q15_5",
        text: "Which functional group is present in aspirin?",
        category: "chemistry",
        options: [
          { id: "A", text: "Aldehyde" },
          { id: "B", text: "Ketone" },
      ...
      {
        id: "q16_5",
        text: "Which type of bond is present between hydrogen and chlorine in HCl?",
        category: "chemistry",
        options: [
          { id: "A", text: "Pure covalent" },
          { id: "B", text: "Pure ionic" },
          { id: "C", text: "Polar covalent" },
          { id: "D", text: "Metallic" },
          { id: "E", text: "Hydrogen bond" },
        ],
        correctOption: "C",
      },
      {
        id: "q17_5",
        text: "Which of the following does NOT affect the rate of a chemical reaction?",
        category: "chemistry",
        options: [
          { id: "A", text: "Temperature" },
          { id: "B", text: "Concentration of reactants" },
          { id: "C", text: "Surface area of solid reactants" },
          { id: "D", text: "Addition of a catalyst" },
          { id: "E", text: "The enthalpy change (ΔH) of the reaction" },
        ],
        correctOption: "E",
      },
      {
        id: "q18_5",
        text: "At physiological pH (7.4), which amino acid would have a net negative charge?",
        category: "chemistry",
        options: [
          {
            id: "A",
            text: "Alanine (pKa of carboxyl group = 2.3; pKa of amino group = 9.7)",
          },
          {
            id: "B",
            text: "Lysine (pKa of carboxyl group = 2.2; pKa of amino group = 9.0; pKa of side chain = 10.5)",
          },
          {
            id: "C",
            text: "Glutamic acid (pKa of carboxyl group = 2.2; pKa of amino group = 9.7; pKa of side chain = 4.3)",
          },
          {
            id: "D",
            text: "Histidine (pKa of carboxyl group = 1.8; pKa of amino group = 9.2; pKa of side chain = 6.0)",
          },
          {
            id: "E",
            text: "Arginine (pKa of carboxyl group = 2.2; pKa of amino group = 9.0; pKa of side chain = 12.5)",
          },
        ],
        correctOption: "C",
      },
      ...
      {
        id: "q21_5",
        text: "A buffer solution contains equal concentrations of a weak acid (HA) and its conjugate base (A⁻). If the pKa of HA is 4.7, what is the pH of this buffer?",
        category: "chemistry",
        options: [
          { id: "A", text: "2.35" },
          { id: "B", text: "4.7" },
      ...
      {
        id: "q22_5",
        text: "What type of radioactive decay results in the conversion of a neutron into a proton?",
        category: "chemistry",
        options: [
          { id: "A", text: "Alpha decay" },
          { id: "B", text: "Beta decay" },
          { id: "C", text: "Gamma emission" },
          { id: "D", text: "Positron emission" },
          { id: "E", text: "Electron capture" },
        ],
        correctOption: "B",
      },
      {
        id: "q23_5",
        text: "What type of bond connects complementary base pairs in DNA?",
        category: "chemistry",
        options: [
          ...
          { id: "E", text: "Disulfide bond" },
        ],
        correctOption: "C",
      },
      {
        id: "q24_5",
        text: "Which statement about transition metals is INCORRECT?",
        category: "chemistry",
        options: [
          { id: "A", text: "They can form colored compounds" },
          { id: "B", text: "They often show variable oxidation states" },
          { id: "C", text: "They are good conductors of electricity" },
          { id: "D", text: "They all have completely filled d-orbitals" },
          { id: "E", text: "Many form complex ions" },
        ],
        correctOption: "D",
      },
      {
        id: "q25_5",
        text: "During the electrolysis of molten sodium chloride, what happens at the cathode?",
        category: "chemistry",
        options: [
          { id: "A", text: "Sodium ions gain electrons to form sodium metal" },
          {
            id: "B",
            text: "Chloride ions lose electrons to form chlorine gas",
          },
          { id: "C", text: "Water is reduced to hydrogen gas" },
          { id: "D", text: "Sodium ions lose electrons" },
          { id: "E", text: "Chloride ions gain electrons" },
        ],
        correctOption: "A",
      },
      {
        id: "q26_5",
        text: "According to the kinetic molecular theory of gases, which of the following is TRUE?",
        category: "chemistry",
        options: [
          {
            id: "A",
            text: "Gas particles have strong attractive forces between them",
          },
          {
            id: "B",
            text: "The volume of gas particles is significant compared to the total volume",
          },
          { id: "C", text: "Gas particles are in constant, random motion" },
          { id: "D", text: "Collisions between gas particles are not elastic" },
          {
            id: "E",
            text: "The average kinetic energy decreases with increasing temperature",
          },
        ],
        correctOption: "C",
      },
      {
        ...
        options: [
          ...
          { id: "B", text: "Triglyceride" },
          { id: "C", text: "Phospholipid" },
          { id: "D", text: "Steroid" },
          { id: "E", text: "Glycogen" },
        ],
        correctOption: "E",
      ...
      {
        id: "q28_5",
        text: "Which salt is most soluble in water?",
        category: "chemistry",
        options: [
          { id: "A", text: "Silver chloride (AgCl)" },
          { id: "B", text: "Lead sulfide (PbS)" },
          { id: "C", text: "Calcium carbonate (CaCO₃)" },
          { id: "D", text: "Potassium nitrate (KNO₃)" },
          { id: "E", text: "Barium sulfate (BaSO₄)" },
        ],
        correctOption: "D",
      },
      {
        id: "q29_5",
        text: "In SN2 reactions, the rate of reaction depends on:",
        category: "chemistry",
        options: [
          { id: "A", text: "Only the concentration of the substrate" },
          { id: "B", text: "Only the concentration of the nucleophile" },
          {
            id: "C",
            text: "The product of the concentrations of substrate and nucleophile",
          },
          {
            id: "D",
            text: "Neither the concentration of substrate nor nucleophile",
          },
          { id: "E", text: "The concentration of the solvent" },
        ],
        correctOption: "C",
      },
      {
        id: "q30_5",
        text: "Which type of spectroscopy is most useful for determining the functional groups present in an organic compound?",
        category: "chemistry",
        options: [
          { id: "A", text: "UV-Visible spectroscopy" },
          { id: "B", text: "Infrared (IR) spectroscopy" },
          { id: "C", text: "Nuclear Magnetic Resonance (NMR) spectroscopy" },
          { id: "D", text: "Mass spectrometry" },
          { id: "E", text: "X-ray crystallography" },
        ],
        correctOption: "B",
      },
    ],
  ...
  "6": {
    ...
    questions: [
      ...
      {
        id: "q1_6",
        text: "A 70 kg person stands on a scale in an elevator. When the elevator accelerates upward at 2 m/s², what is the apparent weight of the person? (g = 9.8 m/s²)",
        category: "physics_math",
        options: [
          { id: "A", text: "686 N" },
          { id: "B", text: "826 N" },
      ...
      {
        id: "q2_6",
        text: "Which of the following statements about interference of light waves is correct?",
        category: "physics_math",
        options: [
          {
            id: "A",
            text: "Constructive interference occurs when the path difference is equal to (n+1/2)λ",
          },
          {
            id: "B",
            text: "Destructive interference occurs when the path difference is equal to nλ",
          },
          {
            id: "C",
            text: "Constructive interference occurs when the path difference is equal to nλ",
          },
          {
            id: "D",
            text: "Interference patterns can only be observed with monochromatic light",
          },
          {
            id: "E",
            text: "Interference cannot occur between waves from different sources",
          },
        ],
        correctOption: "C",
      },
      {
        id: "q3_6",
        text: "A projectile is launched with an initial velocity of 50 m/s at an angle of 30° above the horizontal. What is its maximum height? (g = 9.8 m/s²)",
        category: "physics_math",
        options: [
          { id: "A", text: "31.9 m" },
          { id: "B", text: "63.8 m" },
      ...
      {
        id: "q4_6",
        text: "In a thermodynamic process, a gas expands from 2.0 L to 5.0 L against a constant external pressure of 1.0 atm. The initial temperature is 300 K and the final temperature is 350 K. If the internal energy of the gas increases by 500 J, how much heat was added to the system? (1 L·atm = 101.3 J)",
        category: "physics_math",
        options: [
          { id: "A", text: "500 J" },
          { id: "B", text: "804 J" },
      ...
      {
        id: "q5_6",
        text: "In an AC circuit, what is the relationship between the peak voltage (V₀) and the RMS voltage (Vrms)?",
        category: "physics_math",
        options: [
          { id: "A", text: "Vrms = V₀" },
          { id: "B", text: "Vrms = V₀/√2" },
      ...
      {
        id: "q6_6",
        text: "A neutron star has a radius of 10 km and a mass 1.5 times that of the Sun. What is the escape velocity from its surface? (G = 6.67 × 10⁻¹¹ N·m²/kg², MSun = 2 × 10³⁰ kg)",
        category: "physics_math",
        options: [
          { id: "A", text: "1.5 × 10⁵ m/s" },
          { id: "B", text: "3 × 10⁵ m/s" },
      ...
      {
        id: "q7_6",
        text: "An object with a mass of 2 kg is attached to a spring with a spring constant of 50 N/m. If the object is displaced 0.1 m from its equilibrium position and released, what is its maximum velocity?",
        category: "physics_math",
        options: [
          { id: "A", text: "0.5 m/s" },
          { id: "B", text: "0.25 m/s" },
      ...
      {
        id: "q8_6",
        text: "A radioactive sample has a half-life of 5 days. If the initial activity is 800 Bq, what will be the activity after 15 days?",
        category: "physics_math",
        options: [
          { id: "A", text: "267 Bq" },
          { id: "B", text: "400 Bq" },
      ...
      {
        id: "q9_6",
        text: "Two capacitors of 4 μF and 6 μF are connected in series. What is their equivalent capacitance?",
        category: "physics_math",
        options: [
          { id: "A", text: "10 μF" },
          { id: "B", text: "2.4 μF" },
      ...
      {
        id: "q10_6",
        text: "In a Young's double-slit experiment, coherent light with a wavelength of 600 nm passes through two slits separated by 0.3 mm. What is the angular position of the second bright fringe on the screen?",
        category: "physics_math",
        options: [
          { id: "A", text: "2.0 × 10⁻³ rad" },
          { id: "B", text: "4.0 × 10⁻³ rad" },
          { id: "C", text: "6.0 × 10⁻³ rad" },
          { id: "D", text: "8.0 × 10⁻³ rad" },
          { id: "E", text: "1.0 × 10⁻² rad" },
        ],
        correctOption: "B",
      },
      {
        id: "q11_6",
        text: "A uniform solid sphere and a uniform solid cylinder, both with the same mass and radius, roll down an inclined plane without slipping. Which reaches the bottom first?",
        category: "physics_math",
        options: [
          { id: "A", text: "The sphere reaches first" },
          { id: "B", text: "The cylinder reaches first" },
          { id: "C", text: "Both reach at the same time" },
          { id: "D", text: "It depends on the angle of the incline" },
          { id: "E", text: "It depends on the surface material" },
        ],
        correctOption: "A",
      },
      {
        id: "q12_6",
        text: "A 2.0 kg block slides on a frictionless horizontal surface with a speed of 4.0 m/s when it encounters a spring with a spring constant of 100 N/m. How far will the spring be compressed before the block comes to a momentary stop?",
        category: "physics_math",
        options: [
          { id: "A", text: "0.4 m" },
          { id: "B", text: "0.8 m" },
      ...
      {
        id: "q13_6",
        text: "Light of wavelength 550 nm travels from air into a material with a refractive index of 1.5. What is the wavelength of the light in the material?",
        category: "physics_math",
        options: [
          { id: "A", text: "825 nm" },
          { id: "B", text: "367 nm" },
      ...
      {
        id: "q14_6",
        text: "What is the electric potential at a distance of 3 m from a point charge of 5 nC? (k = 9 × 10⁹ N·m²/C²)",
        category: "physics_math",
        options: [
          { id: "A", text: "15 V" },
          { id: "B", text: "45 V" },
      ...
      {
        id: "q15_6",
        text: "A heat engine operates between reservoirs at 400 K and 300 K. What is the maximum possible efficiency of this engine?",
        category: "physics_math",
        options: [
          { id: "A", text: "100%" },
          { id: "B", text: "75%" },
      ...
      // Mathematics Questions (15 questions)
      {
        ...
        options: [
          { id: "A", text: "f'(x) = e^x · sin(x)" },
          { id: "B", text: "f'(x) = e^x · cos(x)" },
          { id: "C", text: "f'(x) = e^x · [sin(x) + cos(x)]" },
          { id: "D", text: "f'(x) = e^x · [sin(x) - cos(x)]" },
          { id: "E", text: "f'(x) = e^x · sin(x) + e^x · cos(x)" },
        ],
        correctOption: "C",
      ...
      {
        id: "q17_6",
        text: "A doctor administers a drug to a patient. The concentration of the drug in the bloodstream after t hours is given by C(t) = 10t·e^(-0.5t) mg/L. At what time is the concentration at its maximum?",
        category: "physics_math",
        options: [
          { id: "A", text: "0.5 hours" },
          { id: "B", text: "1 hour" },
      ...
      {
        id: "q18_6",
        text: "In a study of the relationship between study time (x hours) and exam scores (y points), the regression line was found to be y = 60 + 5x. If a student studies for 8 hours, what is the predicted exam score?",
        category: "physics_math",
        options: [
          { id: "A", text: "65 points" },
          { id: "B", text: "68 points" },
          { id: "C", text: "85 points" },
          { id: "D", text: "100 points" },
          { id: "E", text: "120 points" },
        ],
        correctOption: "D",
      },
      {
        ...
        options: [
          ...
          { id: "D", text: "14 square units" },
          { id: "E", text: "16⅔ square units" },
        ],
        correctOption: "D",
      },
      {
        id: "q20_6",
        text: "A bag contains 4 red balls and 6 blue balls. If 3 balls are drawn without replacement, what is the probability that exactly 2 of them are red?",
        category: "physics_math",
        options: [
          { id: "A", text: "0.25" },
          { id: "B", text: "0.36" },
      ...
      {
        id: "q21_6",
        text: "The concentration of a drug in a patient's bloodstream decreases exponentially with time. If the initial concentration is 100 mg/L and after 4 hours it is 25 mg/L, what is the half-life of the drug?",
        category: "physics_math",
        options: [
          { id: "A", text: "1 hour" },
          { id: "B", text: "2 hours" },
      ...
      {
        id: "q22_6",
        text: "A study found that the probability of a certain medical test giving a positive result when a disease is present is 0.95 (sensitivity). The probability of a negative result when the disease is absent is 0.98 (specificity). If 2% of the population has the disease, what is the probability that a person with a positive test result actually has the disease?",
        category: "physics_math",
        options: [
          { id: "A", text: "0.95" },
          { id: "B", text: "0.5" },
      ...
      {
        id: "q23_6",
        text: "A scientist is studying the growth of a bacterial culture. The number of bacteria after t hours is given by N(t) = 1000 · 2^(t/3). How many bacteria will be present after 12 hours?",
        category: "physics_math",
        options: [
          { id: "A", text: "4,000" },
          { id: "B", text: "8,000" },
      ...
      {
        id: "q24_6",
        text: "In a normal distribution with mean μ = 70 and standard deviation σ = 5, what percentage of values lie between 65 and 75?",
        category: "physics_math",
        options: [
          { id: "A", text: "38%" },
          { id: "B", text: "50%" },
      ...
      {
        id: "q25_6",
        text: "If log₂(x) = 3 and log₂(y) = 5, what is the value of log₂(xy)?",
        category: "physics_math",
        options: [
          { id: "A", text: "2" },
          { id: "B", text: "8" },
      ...
      {
        id: "q26_6",
        text: "The concentration of a drug in a patient's bloodstream t hours after administration is given by C(t) = 10(e^(-0.2t) - e^(-0.5t)) mg/L. What is the concentration after 2 hours?",
        category: "physics_math",
        options: [
          { id: "A", text: "1.83 mg/L" },
          { id: "B", text: "2.31 mg/L" },
      ...
      {
        id: "q27_6",
        text: "A diagnostic test for a disease has a sensitivity of 90% and a specificity of 80%. If 5% of the population has the disease, what is the positive predictive value of the test?",
        category: "physics_math",
        options: [
          { id: "A", text: "5%" },
          { id: "B", text: "19%" },
      ...
      {
        id: "q28_6",
        text: "In a binomial distribution with n = 10 and p = 0.4, what is the probability of exactly 4 successes?",
        category: "physics_math",
        options: [
          { id: "A", text: "0.121" },
          { id: "B", text: "0.215" },
      ...
      {
        id: "q29_6",
        text: "A cylindrical blood vessel has a radius of 2 mm and a length of 10 cm. If the pressure difference between the ends is 1000 Pa and the viscosity of blood is 4 × 10⁻³ Pa·s, what is the volumetric flow rate according to Poiseuille's law?",
        category: "physics_math",
        options: [
          { id: "A", text: "1.6 × 10⁻⁵ m³/s" },
          { id: "B", text: "1.6 × 10⁻⁶ m³/s" },
          { id: "C", text: "3.1 × 10⁻⁷ m³/s" },
          { id: "D", text: "3.1 × 10⁻⁶ m³/s" },
          { id: "E", text: "6.3 × 10⁻⁶ m³/s" },
        ],
        correctOption: "B",
      },
      {
        id: "q30_6",
        text: "The half-life of a radioactive isotope used in a medical tracer is 6 hours. If a patient is injected with 100 MBq of the isotope, what activity remains after 24 hours?",
        category: "physics_math",
        options: [
          { id: "A", text: "25 MBq" },
          { id: "B", text: "12.5 MBq" },
  ...
  "7": {
    ...
    description:
      "Specialized test for critical thinking, reading comprehension, and logical reasoning relevant to IMAT.",
    ...
    questions: [
      ...
      {
        id: "q5_7",
        text: `Read the following passage and answer the question below:\n\nAntibiotics are among the most frequently prescribed medications in modern medicine. Antibiotics cure disease by killing or injuring bacteria. The first antibiotic was penicillin, discovered accidentally by Alexander Fleming in 1928. After the first use of antibiotics in the 1940s, they transformed medical care and dramatically reduced illness and death from infectious diseases. However, over the decades, bacteria have shown a remarkable ability to become resistant to antibiotics, especially due to overuse or misuse of these medications.\n\nWhat conclusion can be drawn from this passage?`,
        category: "reading",
        options: [
          {
            id: "A",
            text: "Alexander Fleming intentionally developed penicillin to combat bacterial infections",
          },
          {
            id: "B",
            text: "Antibiotics are effective against all types of infections, including viral ones",
          },
          {
            id: "C",
            text: "The effectiveness of antibiotics has diminished over time due to bacterial resistance",
          },
          {
            id: "D",
            text: "Antibiotics should be prescribed for all types of illness to prevent complications",
          },
          {
            id: "E",
            text: "Bacterial resistance to antibiotics was an unexpected phenomenon",
          },
        ],
        correctOption: "C",
      },
      {
        id: "q6_7",
        text: `Read the following passage and answer the question below:\n\nEpidemiological studies have consistently shown an association between moderate alcohol consumption and reduced risk of heart disease. However, it would be incorrect to conclude that alcohol itself is protective. The apparent benefits of moderate drinking may actually be explained by other factors, such as the fact that people who drink moderately often have healthier lifestyles, higher incomes, and better access to healthcare than abstainers or heavy drinkers. Furthermore, the negative effects of alcohol on other body systems may outweigh any potential cardiovascular benefits.\n\nWhat is the main point of this passage?`,
        category: "reading",
        options: [
          {
            id: "A",
            text: "Moderate alcohol consumption directly reduces the risk of heart disease",
          },
          {
            id: "B",
            text: "The correlation between moderate drinking and heart health may be due to confounding factors",
          },
          {
            id: "C",
            text: "People with higher incomes tend to drink more alcohol than those with lower incomes",
          },
          {
            id: "D",
            text: "Epidemiological studies are not reliable for determining causation",
          },
          {
            id: "E",
            text: "Heavy drinking is worse for heart health than abstaining from alcohol",
          },
        ],
        correctOption: "B",
      },
      {
        id: "q7_7",
        text: `Read the following passage and answer the question below:\n\nRecent advances in induced pluripotent stem cell (iPSC) technology have revolutionized the field of regenerative medicine. iPSCs are adult cells that have been genetically reprogrammed to an embryonic stem cell-like state. Unlike embryonic stem cells, iPSCs can be created without the controversial use of embryos, potentially providing an unlimited source of any type of human cell for therapeutic purposes. However, significant technical challenges and safety concerns remain before iPSC-based therapies can be widely implemented in clinical settings.\n\nWhich of the following statements best reflects the author's perspective on iPSC technology?`,
        category: "reading",
        options: [
          {
            id: "A",
            text: "iPSC technology is not ethically superior to using embryonic stem cells",
          },
          {
            id: "B",
            text: "iPSC technology should replace all current medical treatments",
          },
          {
            id: "C",
            text: "iPSC technology has transformative potential but faces important limitations",
          },
          {
            id: "D",
            text: "iPSC technology is too dangerous to pursue for human applications",
          },
          {
            id: "E",
            text: "iPSC technology has already solved the major problems in regenerative medicine",
          },
        ],
        correctOption: "C",
      },
      {
        id: "q8_7",
        text: `Read the following passage and answer the question below:\n\nThe placebo effect is a remarkable phenomenon where a patient's symptoms can improve through the belief that they are receiving an effective treatment, even when the treatment has no active therapeutic properties. Recent neuroscience research has demonstrated that placebos can trigger real neurobiological responses, including the release of endorphins and changes in brain activity. Interestingly, studies have shown that placebos can be effective even when patients are told they are receiving a placebo, suggesting that the mechanisms behind the placebo effect are more complex than simple deception.\n\nBased on the passage, which statement about placebos is most accurate?`,
        category: "reading",
        options: [
          {
            id: "A",
            text: "Placebos are only effective when patients believe they are receiving real medicine",
          },
          {
            id: "B",
            text: "The placebo effect is entirely psychological with no physical basis",
          },
          {
            id: "C",
            text: "Placebos work by inducing measurable biological changes in the body",
          },
          {
            id: "D",
            text: "Doctors routinely use placebos instead of actual treatments",
          },
          {
            id: "E",
            text: "The placebo effect only works for pain-related conditions",
          },
        ],
        correctOption: "C",
      },
      {
        id: "q9_7",
        text: `Read the following passage and answer the question below:\n\nEvidence-based medicine (EBM) is an approach to medical practice that emphasizes the use of evidence from well-designed and well-conducted research to guide clinical decision making. EBM integrates clinical expertise with the best available external clinical evidence from systematic research and patient values and preferences. While the principles of EBM are widely accepted, critics argue that it sometimes overemphasizes randomized controlled trials and statistical analyses at the expense of clinical judgment and individual patient considerations.\n\nAccording to the passage, a challenge of evidence-based medicine is that it may:`,
        category: "reading",
        options: [
          {
            id: "A",
            text: "Completely disregard patient preferences in treatment decisions",
          },
          {
            id: "B",
            text: "Give insufficient importance to the clinician's experience and judgment",
          },
          {
            id: "C",
            text: "Eliminate the need for clinical trials in medical research",
          },
          { id: "D", text: "Increase the cost of healthcare delivery systems" },
          {
            id: "E",
            text: "Take too much time to implement in emergency situations",
          },
        ],
        correctOption: "B",
      },
      {
        id: "q10_7",
        text: `Read the following passage and answer the question below:\n\nThe concept of "personalized medicine" refers to the tailoring of medical treatment to the individual characteristics of each patient. This approach relies heavily on scientific breakthroughs in our understanding of how a person's genetic makeup (genome) affects their response to certain drugs. Pharmacogenomics, the study of how genes affect a person's response to drugs, is a critical component of personalized medicine. By analyzing a patient's genetic profile, healthcare providers can potentially predict which medications will be most effective and which might cause serious side effects, thus improving treatment outcomes and reducing adverse drug reactions.\n\nWhich of the following best describes the relationship between pharmacogenomics and personalized medicine?`,
        category: "reading",
        options: [
          {
            id: "A",
            text: "Pharmacogenomics is a technique used to edit genes for treating genetic disorders",
          },
          {
            id: "B",
            text: "Pharmacogenomics is one tool that contributes to the broader approach of personalized medicine",
          },
          {
            id: "C",
            text: "Personalized medicine is a subset of pharmacogenomics focused on cancer treatments",
          },
          {
            id: "D",
            text: "Pharmacogenomics and personalized medicine are synonymous terms in medical practice",
          },
          {
            id: "E",
            text: "Personalized medicine was developed before pharmacogenomics became possible",
          },
        ],
        correctOption: "B",
      },
      ...
      {
        id: "q16_7",
        text: "A patient needs to take a certain medication every 8 hours. If they take the first dose at 6:00 AM on Monday, when will they take their 10th dose?",
        category: "logical_reasoning",
        options: [
          { id: "A", text: "6:00 PM on Wednesday" },
          { id: "B", text: "6:00 AM on Thursday" },
          { id: "C", text: "10:00 PM on Wednesday" },
          { id: "D", text: "2:00 PM on Wednesday" },
          { id: "E", text: "10:00 AM on Thursday" },
        ],
        correctOption: "D",
      },
      {
        id: "q17_7",
        text: "Five doctors (A, B, C, D, and E) are scheduled for night shifts. If A cannot work on the same night as B, C must work with D, and E cannot work with C, what is the maximum number of doctors that can work on the same night?",
        category: "logical_reasoning",
        options: [
          { id: "A", text: "2 doctors" },
          { id: "B", text: "3 doctors" },
          { id: "C", text: "4 doctors" },
          { id: "D", text: "5 doctors" },
          { id: "E", text: "It depends on which doctors are selected" },
        ],
        correctOption: "B",
      },
      {
        id: "q18_7",
        text: "In a clinical trial for a new drug, the probability of improvement for patients receiving the drug is 0.7, while the probability of improvement with a placebo is 0.3. If 100 patients receive the drug and 100 receive the placebo, what is the expected difference in the number of patients showing improvement between the two groups?",
        category: "logical_reasoning",
        options: [
          { id: "A", text: "10 patients" },
          { id: "B", text: "20 patients" },
          { id: "C", text: "30 patients" },
          { id: "D", text: "40 patients" },
          { id: "E", text: "50 patients" },
        ],
        correctOption: "D",
      },
      {
        id: "q19_7",
        text: "A certain disease affects 1 in 10,000 people. A test for this disease has 99% sensitivity (true positive rate) and 98% specificity (true negative rate). If a person tests positive, what is the approximate probability that they actually have the disease?",
        category: "logical_reasoning",
        options: [
          { id: "A", text: "99%" },
          { id: "B", text: "50%" },
      ...
      {
        id: "q20_7",
        text: "A hospital has 3 departments: Surgery, Internal Medicine, and Pediatrics. Each department needs to select a representative for a committee. If Surgery has 20 doctors, Internal Medicine has 15 doctors, and Pediatrics has 10 doctors, in how many different ways can the committee be formed with one doctor from each department?",
        category: "logical_reasoning",
        options: [
          { id: "A", text: "45 ways" },
          { id: "B", text: "300 ways" },
          { id: "C", text: "3,000 ways" },
          { id: "D", text: "900 ways" },
          { id: "E", text: "8,000 ways" },
        ],
        correctOption: "C",
      },
    ],
...
export default function MockTest() {
  ...
  const validateTest = (testData: any) => {
    ...
    const expectedQuestionCount = {
      ...
      "6": 30, // Physics & Mathematics Focus Test
    ...
    console.log(
      `Test ID: ${testId}, Expected: ${expectedCount}, Actual: ${actualQuestionCount}`
    );
  ...
  const downloadPDF = () => {
    ...
    // Define correct, incorrect and unanswered arrays for the PDF
    const correctAnswers = currentTest.questions.filter(
      (q: any) => userAnswers[q.id] === q.correctOption
    );

    const incorrectAnswers = currentTest.questions.filter(
      (q: any) =>
        userAnswers[q.id] !== null && userAnswers[q.id] !== q.correctOption
    );

    const unansweredQuestions = currentTest.questions.filter(
      (q: any) => userAnswers[q.id] === null
    );
    ...
    doc.text(currentTest.title, 105, 20, { align: "center" });

    doc.setFontSize(14);
    doc.text("Question Paper", 105, 30, { align: "center" });

    // Test info
    doc.setFontSize(10);
    doc.setTextColor(60, 60, 60);
    doc.roundedRect(20, 35, 170, 25, 3, 3, "S");
    doc.text(`Time Limit: ${currentTest.timeLimit} minutes`, 25, 45);
    doc.text(`Total Questions: ${currentTest.questions.length}`, 25, 52);
    doc.text(`Scoring: +1.5 correct, -0.4 incorrect, 0 unanswered`, 105, 45);
    doc.text(`Date: ${new Date().toLocaleDateString()}`, 105, 52);
    ...
    let currentPage = 3; // Starting page for questions (after TOC)

    Object.entries(getQuestionsByCategory()).forEach(
      ([category, questions]) => {
        ...
        doc.text(categoryNames[category] || category, 30, tocY);
        doc.text(`Page ${currentPage}`, 170, tocY, { align: "right" });
        tocY += 10;

        // Estimate pages (roughly 6 questions per page)
        currentPage += Math.ceil(questions.length / 6);
      }
    );

    // Add answer key to TOC
    pageNumbers["answers"] = currentPage;
    doc.text("Answer Key", 30, tocY);
    doc.text(`Page ${currentPage}`, 170, tocY, { align: "right" });

    // Questions section by category
    let currentCategoryPage = 3;
    ...
    Object.entries(getQuestionsByCategory()).forEach(
      ([category, questions]) => {
        ...
        doc.setFontSize(16);
        doc.setTextColor(0, 51, 102);
        doc.text(categoryNames[category] || category, 105, 20, {
          align: "center",
        });
        ...
        questions.forEach((question: any) => {
          ...
          if (yPos > 250) {
            ...
            doc.text(`${categoryNames[category]} (continued)`, 105, 15, {
              align: "center",
            });
          ...
          const questionText = `Question ${qNum}: ${question.text}`;
          ...
          question.options.forEach((option: any) => {
            ...
            doc.circle(25, yPos - 2, 2.5, "FD");
            doc.setTextColor(0, 0, 0);
            doc.text(option.id, 25, yPos - 1, { align: "center" });

            // Option text with wrapping
            const optionText = option.text;
            const splitOption = doc.splitTextToSize(optionText, 155);
            doc.text(splitOption, 30, yPos);
            yPos += 7 * splitOption.length;
          });

          yPos += 10; // Space between questions
        });

        currentCategoryPage = pageNumbers[category];
      }
    );
    ...
    for (let table = 0; table < tableCount; table++) {
      ...
      for (let i = startIdx; i < endIdx; i++) {
        ...
        tableData.push([
          ...
          {
            content: categoryNames[question.category] || question.category,
            styles: { fontSize: 8, halign: "left" },
          },
          {
            content: question.correctOption,
    ...
    const percentageScore = Math.round(
      (displayedScore / totalPossibleScore) * 100
    );
    ...
    doc.setFontSize(14);
    doc.text(unansweredQuestions.length.toString(), 65, 150, {
      align: "center",
    });
    ...
    doc.setFontSize(14);
    doc.text(formatTime(currentTest.timeLimit * 60 - timeRemaining), 145, 150, {
      align: "center",
    });
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="border-t border-b border-gray-200 py-4 my-6">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900">
                  +1.5 correct, -0.4 incorrect, 0 unanswered
                </span>
              </div>
            </div>

            <div className="bg-yellow-50 p-4 rounded-md mb-6">
              <h2 className="font-medium text-yellow-800 mb-2">
              ...
              <ul className="list-disc pl-5 text-yellow-700 text-sm space-y-1">
                ...
                <li>
                  When the time is up, the test will be automatically submitted.
                </li>
              </ul>
            </div>
  ...
  if (testCompleted) {
    ...
    const correctAnswers = currentTest.questions.filter(
      (q: any, idx: number) => userAnswers[q.id] === q.correctOption
    );
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <p className="text-gray-700 mb-6">
              You have completed the {currentTest.title}.
            </p>
            ...
            {incorrectAnswers.length > 0 && (
              <div className="mb-8">
                <h3 className="text-lg font-medium text-gray-900 mb-4">
                  Questions You Attempted Wrong
                </h3>

                <div className="mb-4 flex flex-wrap gap-2">
                  {Object.entries(incorrectByCategory).map(
                    ([category, questions]) => {
                          ...
                          {questions.map((question: any) => (
                            ...
                            >
                              <p className="font-medium text-gray-900">
                                Question{" "}
                                {currentTest.questions.findIndex(
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white shadow-sm p-4 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            {/* Mobile Question Navigation Toggle Button */}
            <button
              onClick={() => setMobileNavOpen(!mobileNavOpen)}
              className="lg:hidden px-3 py-1 rounded-md text-blue-800 font-medium border border-blue-600"
            >
              {mobileNavOpen ? "Close" : "Questions"}
            </button>
      ...
      {mobileNavOpen && (
        <div className="lg:hidden fixed inset-0 z-20 overflow-hidden">
              ...
              <div className="relative w-screen max-w-md">
                <div className="h-full flex flex-col py-6 bg-white shadow-xl overflow-y-auto">
                  ...
                  <div className="mt-6 relative flex-1 px-4 sm:px-6">
                    {/* Question navigation content - same as desktop but for mobile */}
          ...
          <div className="hidden lg:block bg-white p-4 rounded-lg shadow-md h-fit sticky top-24">
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
              <div className="flex items-center justify-between text-sm mb-2">
                ...
                <span className="font-medium text-gray-900">
                  {
                    Object.values(userAnswers).filter((ans) => ans !== null)
                      .length
                  }{" "}
                  / {currentTest.questions.length}
                </span>
