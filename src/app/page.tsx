      ...
      <div className="relative w-full h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-white mb-8 max-w-2xl">
            Practice with mock tests based on real IMAT exams. No account needed
            - start right away!
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white w-full">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">
            Features designed for IMAT success
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Practice with tests that follow the exact IMAT format with
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                ...
                performance metrics, and personalized insights.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Fresh content added every Saturday to help you practice with
                diverse questions and stay ahead of the competition.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-8">
            ...
            <p className="text-gray-600 mb-4">
              The IMAT comprises 60 multiple-choice questions to be completed
              within 100 minutes. Each question offers five options, with only
              one correct answer.
            </p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-600">
                  Every question is carefully developed by professionals with
                  expertise in IMAT exam patterns. Our content is unique - you
                  won&apos;t find repeated or recycled questions from other
                  platforms.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600">
                  Unlike general platforms, we focus exclusively on IMAT
                  preparation. Our specialized approach ensures you&apos;re
                  practicing with the most relevant and accurate mock tests
                  available.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600">
                  Each question undergoes rigorous review to ensure accuracy,
                  relevance, and appropriate difficulty. We prioritize
                  high-quality content that truly prepares you for the actual
                  exam.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600">
                  Our tests mimic the exact format, timing, and pressure of the
                  real IMAT examination, giving you the most authentic practice
                  experience possible.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-600 w-full">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to practice for your IMAT exam?
          </h2>
